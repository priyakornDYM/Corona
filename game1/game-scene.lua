...
local function copynewGem (i,j,coler)
    ...
    --    backgroundTop = display.newImageRect( "image/lay_bt00top.png" , 320, display.contentHeight/2 - 27 )
    ...
    local picture
    if R == "RED" then
        picture =  "image/RED.png"
    end
    if R == "GREEN" then
        picture =  "image/GREEN.png"
    end
    if R == "BLUE" then
        picture =  "image/BLUE.png"
    end
    if R == "PURPLE" then
        picture =  "image/PURPLE.png"
    end
    if R == "PINK" then
        picture =  "image/PINK.png"
    end
    if R == "YELLOW" then
        picture =  "image/YELLOW.png"
    end
            ...
            if gemsTable[i][j].isMarkedToDestroy then
                ...
                if gemsTable[i][j].gemType == "PINK" then
                    ...
                    if PINK <= 150 then
                        ...
                        powerBar = display.newImageRect("image/bt_p_hpbar.png",PINK,6)
                        powerBar.x = 90 + PINK
                        powerBar.y =  207
...
function scene:createScene( event )
    ...
    --score text
    background = display.newImageRect( "image/lay_bt00.png" , display.contentWidth, display.contentHeight )
...
--    backgroundTop.x, backgroundTop.y = 0, 0
    ...
    powerBar = display.newImageRect("image/bt_p_hpbar.png",4,6)
    -- powerBar.x = 97 +  PINK
    -- powerBar.y =  207
